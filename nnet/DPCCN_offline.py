...
from wesep_stuff.preproc import PreEmphasis, SpeakerFuseLayer, SpeakerTransform
from wesep_stuff.resnet import ResNet34 as ResNet
...
class DenseUNet(nn.Module):
    def __init__(self, 
        ...
        pretrained_model = torch.load(encoder_path)
